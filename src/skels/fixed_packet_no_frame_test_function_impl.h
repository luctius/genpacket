...
#ifndef FIXED_PACKET_NO_FRAME_TEST_FUNCTION_IMPL_GEN_STRUCT_H
#define FIXED_PACKET_NO_FRAME_TEST_FUNCTION_IMPL_GEN_STRUCT_H
...
struct fixed_packet_no_frame_test_function_impl_gen_struct
{
  const char *name;
  int packet_size;
  const char *prefix;
...
#endif /* __cplusplus */
#endif // FIXED_PACKET_NO_FRAME_TEST_FUNCTION_IMPL_GEN_STRUCT_H
