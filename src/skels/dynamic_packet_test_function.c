...
#include "dynamic_packet_test_function.h"
...
{
  struct dynamic_packet_test_function_gen_struct record;
  ...
  generate_dynamic_packet_test_function (stream, &record, indent);
}
...
genstring_dynamic_packet_test_function(struct dynamic_packet_test_function_gen_struct *record, unsigned int indent)
{
  ...
  len = strcnt_dynamic_packet_test_function (record, indent);
...
genstringp_dynamic_packet_test_function(unsigned int indent, const char *name, int packet_size, const char *prefix, const char *test_frame_dynamic)
{
  ...
  return genstring_dynamic_packet_test_function (&record, indent);
}
